...
const exportFn = async function (arg) {
  ...
  try {
    ...
    newCustomer.to_date.average_spent = parseInt(refuelAggregate[0].avgAmount.toFixed(0));
    newCustomer.to_date.average_litres = parseInt(refuelAggregate[0].avgLitres.toFixed(0));
